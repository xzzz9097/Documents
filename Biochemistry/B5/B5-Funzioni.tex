...
\begin{tikzpicture}[node distance = 2cm, trim left = (1), trim right = (1)]
    ...
    \path [line] (1) -- (2) node [midway, left, xshift = -2mm] {\textit{PanK}};
    \path [line] (2) -- (3) node [midway, left, xshift = -2mm] {\textit{4'-fosfopantotenilcistina sintetasi}};
    \path [line] (3) -- (4) node [midway, left, xshift = -2mm] {\textit{4'-fosfopantotenilcistina decarbossilasi}};
    \path [line] (4) -- (5) node [midway, left, xshift = -2mm] {\textit{Defosfo-CoA pirofosforilasi}};
    \path [line] (5) -- (6) node [midway, left, xshift = -2mm] {\textit{Defosfo-CoA chinasi}};
...
\begin{center}
\begin{tikzpicture}[node distance = 1.3cm, auto, trim left = (1), trim right = (1)]
