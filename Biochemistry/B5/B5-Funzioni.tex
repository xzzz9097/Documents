...
\schemestop
\end{center}
La coniugazione di un gruppo acilico a CoA richiede consumo di energia, necessaria ad \textit{attivare} l'acido grasso per renderlo disponibile all'attacco del coenzima. In particolare abbiamo:
...
ATP \+
\chemname{\chemfig{R-C(=[:90]O)-O^{-}}}{Gruppo acile}
\arrow[-90] \chemname{\chemfig{R-C(=[:90]O)-O-AMP}}{Acil-adenilato}
\arrow[-90]
AMP \+
