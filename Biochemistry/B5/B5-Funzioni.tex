...
\chemname{\chemfig{R-C(=[:90]O)-O-PO_2^{-}-O-[:0, 1.5]{Ribosio}-[:0, 2]{Adenina}}}{Acil-adenilato}
\arrow{-U>[*{0}CoA-SH]}[-90]
...
\begin{tikzpicture}[auto, trim left = (5), trim right = (5)]
    ...
    \node (6) [block, below = 0.5cm of 5]{butirril-ACP};
    \node (7) [block, below = 0.5cm of 6]{C6-ACP};
    \node (8) [block, below = 0.5cm of 7]{C8-, C10-, Cn-ACP};
    \node (9) [block, below = 0.5cm of 8]{palmitil-ACP (C16)};
