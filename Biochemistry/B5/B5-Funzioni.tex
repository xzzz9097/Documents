...
Esso partecipa inoltre alla biosintesi del \textbf{colesterolo}, che inizia con la condensazione di due molecole di acetil-CoA formando acetoacetil-CoA. Esso reagisce poi con una terza unità di acetil-CoA, dando luogo all'\textbf{acido mevalonico}.
L'acido mevalonico è un importante intermedio metabolico, essendo precursore sia del colesterolo, che di altri lipidi come gli \textbf{isoprenoidi}.
