...
\def \CoA {\tiny\chemfig{HS-CH_2-CH_2-NH-C(=[:90]O)-CH_2-CH_2-NH-C(=[:90]O)-CH(-[:270]OH)-C(-[:90]CH_3)(-[:270]CH_3)-CH_2-O-PO_2^{-}-O-PO_2^{-}-O-CH_2!{ribosiofosfatoadenina}}}
...
Il legame fra un gruppo acilico od acetilico, e quello tiolico della fosfopanteina, porta alla formazione di un tioestere, rispettivamente \textbf{acil-CoA} o \textbf{acetil-CoA}. Essi sono \textbf{composti ad alta energia}, a causa della natura instabile del legame tioestereo, il cui $\Delta G'\degree$ di idrolisi permette lo svolgimento di numerose reazioni biochimiche.
...
\arrow(.mid east--.mid west){<=>} \chemname{\chemfig{CH_3-C(=[:90]O)-S-CoA}}{Tioestere} \+
AMP \+
PP\textsubscript{i}
\schemestop
\end{center}
...
\tiny
\schemestart
\chemname{\chemfig{PO_3^{2-}-O-PO_2^{-}-O-PO_2^{-}-O-PO_2^{-}-O-[:0, 1.5]{Ribosio}-[:0, 2]{Adenina}}}{ATP} \+
\chemname{\chemfig{R-C(=[:90]O)-O^{-}}}{Gruppo acile}
