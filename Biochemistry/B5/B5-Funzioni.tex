...
$\underbrace{\chemfig{O-PO_2^{-}-O-CH_2-CH(-[:90]C(-[:90]...)=O)(-[:270]NH(-[:270]...))}}_{\textnormal{serina}}$
\schemestop
}

\def \ACPtwo {
\tiny
\chemfig{HS-CH_2-CH_2-NH-C(=[:90]O)-CH_2-CH_2-NH-C(=[:90]O)-CH(-[:270]OH)-C(-[:90]CH_3)(-[:270]CH_3)-CH_2-O-PO_2^{-}-O-PO_2^{-}-O-CH_2-CH(-[:90]C(-[:90]...)=O)(-[:270]NH(-[:270]...))}
}
